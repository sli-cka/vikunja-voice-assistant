from custom_components.vikunja.helpers.detailed_response_formatter import friendly_repeat_phrase, build_detailed_response
...
def test_build_detailed_response_full():
    ...
    msg = build_detailed_response(
        task_title='Buy milk',
        task_data={'title':'Buy milk','project_id':2,'due_date':'2099-12-01','priority':3,'repeat_after':86400},
        projects=projects,
        labels=labels,
